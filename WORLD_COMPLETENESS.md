...
- **PM4/PD4** (server-side navigation/pathing mesh) — **no longer fully out
  ...
  **Decided, 2026-08-01**: the "hidden by default" mechanism reuses the
  ...
  importer) or a separate opt-in Blender script — see `PM4_PD4_TODO.md`
